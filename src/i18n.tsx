  ...
  "flights": {
    ...
    "faq": {
      ...
      "checkTicket": {
        ...
        "answer": "برای استعلام بلیط، کافی است به وب‌سایت یا اپلیکیشن پرتو سیر بروید و بعد از مشخص‌کردن مبدا و مقصد، لیست کامل پروازهای شرکت‌های مختلف را ببینید."
      },
      "changeSeat": {
    ...
    "services": {
      "comfort": {
        "title": "سفر راحت و ایمن",
        "description": "با پروازهای مدرن و راحت ما، سفری لذت‌بخش را تجربه کنید"
      },
      "accessibility": {
        "title": "دسترسی آسان",
