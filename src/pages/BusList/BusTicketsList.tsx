...
// import { Box, Typography, Paper, Chip, Stack, Skeleton, useMediaQuery, Button, Divider } from '@mui/material';
...
//   return (
//     <Box sx={{ p: isMobile ? 1 : 2, bgcolor: primaryLighter }}>
//       {tickets.map((ticket) => (
//         <Paper 
//           key={ticket.id}
//           elevation={0}
...
//               mb: 1
//             }}>
//               {ticket.busDetail?.originTerminal || ticket.busDetail?.originCity} → {ticket.busDetail?.destinationTerminal || ticket.busDetail?.destinationCity}
//             </Typography>
...
//                 fontFamily: theme.typography.fontFamily
//               }}>
//                 {ticket.busDetail?.carType}
//               </Typography>
//             </Box>

//             {ticket.busDetail?.description && (
//               <Typography variant="body2" sx={{ 
//                 mt: 1.5,
//                 color: secondaryColor,
//                 fontFamily: theme.typography.fontFamily,
